...
public class fcfs extends AppCompatActivity {
    ...
    EditText fcfs_at,fcfs_bt;
    Button solve_fcfs;
    ScrollView fcfs_view;
    TextView awtp,attp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fcfs_at = (EditText) findViewById(R.id.fcfs_at);
        fcfs_bt = (EditText) findViewById(R.id.fcfs_bt);
        ...
        solve_fcfs = (Button) findViewById(R.id.solve_fcfs);

        fcfs_view = (ScrollView) findViewById(R.id.fcfs_view);

        fcfs_at.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                fcfs_view.setVisibility(View.GONE);
                fcfs_view.setVisibility(View.GONE);
                for(int i = 0; i<9; i++){
        ...
        fcfs_bt.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        solve_fcfs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String fcfs_at_str =  fcfs_at.getText().toString();

                String fcfs_bt_str =  fcfs_bt.getText().toString();

                int[] at = method(fcfs_at_str);
                int[] bt = method(fcfs_bt_str);
                ...
                fcfs_view.setVisibility(View.VISIBLE);
