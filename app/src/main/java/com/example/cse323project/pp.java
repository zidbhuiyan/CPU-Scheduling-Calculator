...
public class pp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pp_at = (EditText) findViewById(R.id.pp_at);
        pp_bt = (EditText) findViewById(R.id.pp_bt);
        pp_p = (EditText) findViewById(R.id.pp_p);
        ...
        solve_pp = (Button) findViewById(R.id.solve_pp);

        pp_view = (ScrollView) findViewById(R.id.pp_view);

        pp_at.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        pp_bt.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        pp_p.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        solve_pp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String pp_at_str =  pp_at.getText().toString();

                String pp_bt_str =  pp_bt.getText().toString();

                String pp_p_str =  pp_p.getText().toString();

                int[] at = method(pp_at_str);
                int[] bt = method(pp_bt_str);
                int[] p = method(pp_p_str);
                ...
                while(true)
                {
                    ...
                    for (int ni=0; ni<numberOfProcesses; ni++)
                    {
                        ...
                        if ((at[ni] <= nst) && (nf[ni] == 0) && (p[ni]<nmin))
                        {
                            nmin=p[ni];
                            nc=ni;
                        }
                ...
                pp_view.setVisibility(View.VISIBLE);
                ...
                for(int po=0;po<tp;po++){
                    gannChartArray[po].setText("P"+newpid[po]);
                    gannChartArray[po].setVisibility(View.VISIBLE);
                }
